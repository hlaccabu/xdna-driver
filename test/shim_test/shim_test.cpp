...
std::vector<test_case> test_list {
  ...
  test_case{ "measure no-op kernel latency elf flow", {},
  ...
  //test_case{ "measure real kernel latency elf flow", {},
  ...
  test_case{ "measure no-op kernel throughput elf flow", {},
  ...
  test_case{ "measure no-op kernel latency chained command elf flow", {},
  ...
  test_case{ "measure no-op kernel throughput chained command elf flow", {},
  ...
  test_case{ "measure no-op kernel latency (polling) elf flow", {},
  ...
  test_case{ "measure no-op kernel throughput (polling) elf flow", {},
  ...
  test_case{ "measure no-op kernel latency chained command (polling) elf flow", {},
  ...
  test_case{ "measure no-op kernel throughput chained command (polling) elf flow", {},
